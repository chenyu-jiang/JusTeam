...
app.use(validator());
app.use("/register", require("./AccountSystem/route/register"));
app.use("/login", require("./AccountSystem/route/login"));
app.use("/requestInformation", require("./AccountSystem/route/requestInformation"));
app.use("/editInformation", require("./AccountSystem/route/editInformation"));
